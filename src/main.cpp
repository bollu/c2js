...
const std::string GHC_BASEDIR="/home/bollu/work/ghc";

int main() {
    cppast::libclang_compile_config config;
    config.add_include_dir(GHC_BASEDIR + "/includes");
    cppast::stderr_diagnostic_logger logger;
    auto file = parse_file(config, logger, GHC_BASEDIR + "/libraries/base/cbits/primFloat.c", /*fatal errors=*/true);
